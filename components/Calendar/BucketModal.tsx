    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center" style={{ backgroundColor: 'rgba(0, 0, 0, 0.5)', transform: 'translateZ(0)', transition: 'none', zIndex: 9998 }} onClick={onClose}>
            ...
            >
                ...
                {/* Form */}
                <form onSubmit={handleSubmit} className="p-4 space-y-2 overflow-y-auto">
                    {/* Section: 버킷 정보 */}
                    ...
                    <div className="flex gap-2 pt-2">
                        {editingBucket && onDelete && (
                            <button
                                ...
                                className="py-2 px-4 bg-red-500 text-white rounded-sm font-bold text-sm hover:bg-red-600 transition-colors flex items-center gap-1"
                            >
                                <X size={14} />
                                <span>삭제</span>
                            </button>
                        ...
                        <button
                            type="button"
                            onClick={onClose}
                            className="flex-1 py-2 px-4 bg-gray-100 text-gray-600 rounded-sm font-bold text-sm hover:bg-gray-200 transition-colors"
                        >
                            취소
                        </button>
                        <button
