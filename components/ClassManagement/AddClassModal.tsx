...
const AddClassModal: React.FC<AddClassModalProps> = ({ onClose, defaultSubject = 'math' }) => {
  ...
  // 스케줄 겹침 감지 (선택된 강사와 겹치는 수업만 체크)
  const scheduleConflicts = useMemo(() => {
    if (!existingClasses || selectedSlots.size === 0 || !mainTeacher.trim()) return [];
    ...
    existingClasses.forEach(cls => {
      ...
      if (cls.teacher !== mainTeacher.trim()) return;
    ...
    return conflicts;
  }, [existingClasses, selectedSlots, mainTeacher]);
          ...
          <div className="bg-white border border-gray-200 overflow-hidden">
            ...
            <div className="p-1.5">
              ...
              {scheduleConflicts.length > 0 && (
                <div className="mt-1.5 bg-amber-50 border border-amber-200 rounded-sm px-2 py-1.5">
