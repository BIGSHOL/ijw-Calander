      ...
      <div className="bg-white rounded-sm shadow-xl w-[400px] max-h-[85vh] flex flex-col overflow-hidden">
        ...
        <div className="p-4 space-y-2 flex-1 overflow-y-auto">
          ...
          <div className="bg-white border border-gray-200 overflow-hidden">
            <div className="flex items-center gap-1 px-2 py-1.5 bg-gray-50 border-b border-gray-200">
              ...
              <h3 className="text-[#081429] font-bold text-xs">수신자 선택</h3>
            </div>
          ...
          <div className="bg-white border border-gray-200 overflow-hidden">
            <div className="flex items-center gap-1 px-2 py-1.5 bg-gray-50 border-b border-gray-200">
              <MessageSquare className="w-3 h-3 text-[#081429]" />
            ...
            <div className="px-2 py-1.5">
              <textarea
                ...
                className="w-full px-3 py-2 border border-gray-200 rounded-sm text-sm focus:ring-1 focus:ring-[#fdb813] focus:border-[#fdb813] outline-none resize-none h-24"
              />
              {!memoMessage.trim() && (
        ...
        <div className="p-4 border-t bg-gray-50 flex justify-end gap-2 shrink-0">
          ...
          <button
            ...
            className="px-4 py-2 bg-[#081429] text-white rounded-sm text-sm font-bold hover:brightness-125 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
          >
