            ...
            <div className="space-y-4">
              ...
              <div>
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="text-sm font-semibold text-gray-900">입력 형식 안내</h3>
                </div>
                <div className="bg-blue-50 border border-blue-200 rounded-sm p-4">
                  <p className="text-sm text-blue-800 mb-2">
                    각 줄에 한 명씩 입력하세요. 형식: <code className="bg-blue-100 px-1 py-0.5 rounded-sm">이름(영어이름)</code>
                  </p>
                  <div className="bg-white border border-blue-200 rounded-sm p-3 text-sm font-mono space-y-1">
                    <div>김나윤A(Chloe)</div>
                    <div>현가현(Sophia)</div>
                    <div>이세인A(Vera)</div>
                    <div>전민석(Min)</div>
              ...
              <div>
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="text-sm font-semibold text-gray-900">학생 목록 입력</h3>
                </div>
                <textarea
                  value={inputText}
              ...
              {parsedEntries.length > 0 && (
                <div>
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <h3 className="text-sm font-semibold text-gray-900">파싱 결과</h3>
                  </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="text-sm font-semibold text-gray-900">업데이트 미리보기</h3>
                </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="text-sm font-semibold text-gray-900">업데이트 완료</h3>
                </div>
