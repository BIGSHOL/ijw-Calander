                ...
                <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-4 space-y-2">
                    ...
                    <div className="bg-white border border-gray-200 overflow-hidden">
                        <div className="flex items-center gap-1 px-2 py-1.5 bg-gray-50 border-b border-gray-200">
                            ...
                            <h3 className="text-[#081429] font-bold text-xs">코멘트 정보</h3>
                        </div>
                        <div className="divide-y divide-gray-100">
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                    <div>
                                        <div className="flex items-center gap-1.5 mb-1">
                                            ...
                                            <label className="text-xs font-medium text-[#373d41]">카테고리</label>
                                        </div>
                                        <select
                                            value={category}
                                    ...
                                    <div>
                                        <div className="flex items-center gap-1.5 mb-1">
                                            ...
                                            <label className="text-xs font-medium text-[#373d41]">과목</label>
                                        </div>
                                        <select
                                            value={subject}
                            ...
                            {/* Content Row */}
                            <div className="px-2 py-1.5">
                                <label className="block text-xs font-medium text-[#373d41] mb-1">
                                    코멘트 내용
