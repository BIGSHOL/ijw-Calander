    ...
    return (
        <div className="fixed inset-0 bg-black/50 z-[9999] flex items-center justify-center p-4 backdrop-blur-sm animate-in fade-in duration-200" onClick={() => setPendingMove(null)}>
            <div className="bg-white rounded-xl shadow-2xl w-[350px] overflow-hidden" onClick={(e) => e.stopPropagation()}>
                ...
                {/* Header */}
                <div className="bg-[#081429] text-white p-3 font-bold text-sm flex justify-between items-center">
                    <span>🚚 이동할 수업 선택</span>
                    <button
                ...
                <div className="p-4 bg-gray-50">
                    ...
                    <div className="space-y-2">
                        ...
                        >
                            ...
                            <span className="text-xs bg-gray-100 px-2 py-1 rounded text-gray-500 group-hover:bg-gray-200 group-hover:text-[#081429] font-bold">
                                이동
                            </span>
                        </button>
                        ...
                        {sourceData.merged && sourceData.merged.map((m: MergedClass, idx: number) => (
                            <button
                                ...
                                className="w-full bg-white border border-yellow-200 p-3 rounded-lg shadow-sm hover:border-yellow-500 hover:bg-yellow-50 flex justify-between items-center group transition-all"
                            >
                                <div className="flex flex-col items-start">
                                ...
                                <span className="text-xs bg-gray-100 px-2 py-1 rounded text-gray-500 group-hover:bg-yellow-200 group-hover:text-yellow-800 font-bold">
                                    이동
                                </span>
                            </button>
                        ))}
                    ...
                    <div className="mt-4 pt-3 border-t flex justify-end gap-2">
                        <button
                            onClick={() => setPendingMove(null)}
                            className="px-3 py-1.5 rounded border bg-white text-gray-500 text-xs font-bold hover:bg-gray-100 transition-colors"
                        >
                            취소
                        </button>
                        ...
                        <button
                            ...
                            className="px-4 py-1.5 rounded bg-[#081429] text-white text-xs font-bold hover:bg-[#081429]/90 shadow-md transition-colors"
                        >
                            모두 이동
                        </button>
                    </div>
