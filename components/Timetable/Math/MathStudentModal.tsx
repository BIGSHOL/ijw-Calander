...
const MathStudentModal: React.FC<MathStudentModalProps> = ({
    ...
    return (
        <div className="fixed inset-0 bg-black/50 z-[100] flex items-start justify-center pt-[8vh]" onClick={handleClose}>
            <div
                className="bg-white rounded-sm shadow-xl w-full max-w-xl max-h-[85vh] flex flex-col overflow-hidden"
            ...
            >
                ...
                <div className="flex items-center justify-between px-3 py-2 border-b border-gray-200">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <button onClick={handleClose} className="p-1 rounded-sm hover:bg-gray-100 text-gray-400 hover:text-gray-600 transition-colors">
                            <X size={18} />
                        </button>
                    </div>
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-2">
                    ...
                    <div className="bg-white border border-gray-200 overflow-hidden">
                        ...
                        <div className="divide-y divide-gray-100">
                            ...
                            <div className="flex items-center gap-2 px-2 py-1.5">
                                ...
                                <span className="text-xs text-primary font-bold">{mathClass.className}</span>
                            </div>
                            {/* Teacher Row */}
                            <div className="flex items-center gap-2 px-2 py-1.5">
                                <span className="w-16 shrink-0 text-xs font-medium text-primary-700">담당강사</span>
                                <span className="text-xs text-primary-700">{mathClass.teacher || '-'}</span>
                            </div>
                            {/* Student Count Row */}
                            <div className="flex items-center gap-2 px-2 py-1.5">
                    ...
                    {/* Section 2: 학생 추가 (Only show if can edit) */}
                    {canEdit && (
                        <div className="bg-white border border-gray-200 overflow-hidden">
                            <div className="flex items-center gap-1 px-2 py-1.5 bg-gray-50 border-b border-gray-200">
                                ...
                                <div className="flex items-end gap-2">
                                    <div className="flex-1 grid grid-cols-3 gap-2">
                                        <div className="col-span-1">
                                            <label className="text-xxs text-gray-500 font-bold mb-1 block">
                                            ...
                                            <input
                                                ...
                                                className="w-full px-2 py-1.5 text-sm border border-gray-300 rounded-sm focus:border-accent focus:ring-1 focus:ring-accent outline-none"
                                    ...
                                    <button
                                        ...
                                        className="px-4 py-1.5 bg-accent text-primary rounded-sm font-bold text-sm hover:bg-[#e5a712] disabled:opacity-50 h-[34px] self-end"
                                    >
                                        추가
                                    </button>
                                </div>
                    ...
                    <div className="bg-white border border-gray-200 overflow-hidden">
                        <div className="flex items-center gap-1 px-2 py-1.5 bg-gray-50 border-b border-gray-200">
                            ...
                            <span className="ml-auto text-xxs text-gray-400">
                                {students.length > 0 ? `총 ${students.length}명` : '등록된 학생이 없습니다'}
                            </span>
                        </div>
                            ...
                            {loading ? (
                                ...
                                <div className="divide-y divide-gray-100">
                                    {sortedStudents.map((student, idx) => (
                                        <div
                                            key={student.id}
                                            className={`flex items-center justify-between py-2 px-3 transition-colors group ${editingStudentId === student.id
                                                ? 'bg-yellow-50'
                                            ...
                                            {editingStudentId === student.id ? (
                                                    ...
                                                    <div className="flex-1 grid grid-cols-12 gap-2">
                                                        <div className="col-span-4">
                                                            <input
                                                                ...
                                                                className="w-full text-sm p-1.5 border rounded-sm"
                                                                placeholder="이름"
                                                                autoFocus
                                                            />
                                                        </div>
                                                        ...
                                                        <div className="col-span-3">
                                                            <input
                                                                ...
                                                                className="w-full text-sm p-1.5 border rounded-sm text-center"
                                                                placeholder="학년"
                                                            />
                                                        </div>
                                                    </div>
                                                ...
                                                <>
                                                    ...
                                                    >
                                                        ...
                                                        <span className={`font-bold text-sm ${student.underline ? 'underline text-blue-600' : 'text-primary-700'}`}>
                                                            {student.name}
                                                        </span>
                                                    ...
                                                    {canEdit && (
                                                        <div className="flex items-center gap-1 shrink-0 opacity-0 group-hover:opacity-100 transition-opacity">
                                                            <button
                                                                ...
                                                                className={`px-2 py-0.5 text-xxs rounded-sm border transition-colors ${student.underline
                                                            ...
                                                            <button
                                                                ...
                                                                className="px-2 py-0.5 text-xxs rounded-sm border bg-white text-red-400 border-gray-200 hover:bg-red-50 hover:text-red-600 hover:border-red-300"
                                                                title="삭제"
                                                            >
                                                                삭제
                                                            </button>
                    ...
                    {/* Section 4: 일괄 작업 (Batch operations info - if needed) */}
                ...
                <div className="flex justify-between items-center p-4 border-t bg-gray-50">
                    {canEdit ? (
                        <>
                            <button
                                onClick={handleDeleteAll}
                                className="flex items-center gap-1 px-3 py-2 text-red-500 hover:bg-red-50 rounded-sm text-sm"
                            ...
                            <div className="flex gap-2">
                                {hasChanges && (
                                    <button
                                        ...
                                        disabled={loading}
                                        className="px-5 py-2 bg-accent text-primary rounded-sm text-sm font-bold hover:brightness-110 disabled:opacity-50"
                                    >
                                        {loading ? '저장 중...' : '저장'}
                                    </button>
                                )}
                                <button
                                    onClick={handleClose}
                                    className="px-5 py-2 bg-primary text-white rounded-sm text-sm font-bold hover:brightness-110"
                                >
                                    닫기
                                </button>
                            </div>
                        ...
                        <button
                            onClick={handleClose}
                            className="ml-auto px-5 py-2 bg-primary text-white rounded-sm text-sm font-bold hover:brightness-110"
                        >
                            닫기
                        </button>
                    )}
