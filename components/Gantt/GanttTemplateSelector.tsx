            ...
            {templates.length === 0 ? (
                <div className="text-center py-16 bg-white rounded-xl border border-dashed border-slate-300">
                    ...
                    {canCreate && (
                        <button
                            onClick={onCreateNew}
                            className="px-6 py-3 bg-[#081429] text-white font-medium rounded-lg hover:bg-[#081429]/90 shadow-md transition"
                        >
                            새 프로젝트 만들기
                        </button>
                    )}
                            ...
                            <div className="absolute top-4 right-4 flex gap-1">
                                {canEdit && (
                                    <button
                                        ...
                                        className="p-1.5 text-slate-400 hover:text-[#081429] hover:bg-slate-100 rounded-full transition-colors z-10"
                                        title="수정"
                                    >
