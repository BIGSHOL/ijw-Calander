        ...
        <div className="flex-1 overflow-auto p-2 space-y-2">
          {suggestions.map((suggestion) => (
            ...
            >
              ...
              <div className="text-xxs text-purple-600 space-y-0.5">
              ...
              <div className="flex gap-1 mt-2">
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-1 px-2 py-1 bg-purple-600 text-white text-xxs rounded hover:bg-purple-700 transition-colors"
                >
                  <Check size={10} />
                  적용
                </button>
                <button
                  ...
                  className="flex items-center justify-center px-2 py-1 bg-gray-100 text-gray-600 text-xxs rounded hover:bg-gray-200 transition-colors"
                >
                  <X size={10} />
                </button>
              </div>
