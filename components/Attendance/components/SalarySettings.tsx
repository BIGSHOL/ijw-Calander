...
const SalarySettings: React.FC<Props> = ({ isOpen, onClose, config, onSave }) => {
      ...
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl overflow-hidden flex flex-col max-h-[90vh]">
        <div className="flex justify-between items-center p-5 border-b border-gray-100 shrink-0">
          <div className="flex items-center gap-2">
             ...
             <h2 className="text-xl font-bold text-gray-800">급여 및 인센티브 설정</h2>
          </div>
             ...
             <div className="flex items-center justify-between bg-white p-3 rounded-lg border border-gray-200">
                ...
                <div className="relative w-32">
                    <input
                        ...
                        className="w-full pl-3 pr-8 py-2 text-right border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    />
                 ...
                 <div className="bg-white p-3 rounded-lg border border-yellow-100">
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full pl-8 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500"
                        />
                    </div>
                 </div>
                 <div className="bg-white p-3 rounded-lg border border-yellow-100">
                 ...
                 <div className="bg-white p-3 rounded-lg border border-yellow-100">
                    ...
                    <div className="relative">
                        <input
                            ...
                            className="w-full pl-3 pr-8 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500"
                        />
                    ...
                    <div className="flex flex-wrap gap-4 items-center mb-4 pr-8">
                        ...
                        <div className="flex items-center gap-2">
                            <input 
                                ...
                                className="font-bold text-lg text-gray-800 border-b border-dashed border-gray-300 focus:border-blue-500 focus:outline-none bg-transparent w-32"
                                placeholder="과정명"
                            />
                        </div>
                        ...
                        <div className="flex bg-gray-100 p-1 rounded-lg ml-auto">
                            <button
                                ...
                                className={`px-3 py-1.5 text-xs font-medium rounded-md transition-all ${
                                    item.type === 'fixed' ? 'bg-white text-gray-800 shadow-sm' : 'text-gray-500 hover:text-gray-700'
                                }`}
                            >
                                고정급
                            </button>
                            <button
                                ...
                                className={`px-3 py-1.5 text-xs font-medium rounded-md transition-all ${
                                    item.type === 'percentage' ? 'bg-white text-blue-600 shadow-sm' : 'text-gray-500 hover:text-gray-700'
                                }`}
                            >
                                비율제
                            </button>
                            ...
                            <div className="md:col-span-2">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-8 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 bg-white"
                                    />
                                </div>
                            </div>
                        ) : (
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            className="w-full pl-3 pr-8 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 bg-white"
                                            placeholder="예: 45"
                                        />
                                        <span className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-500 text-sm">%</span>
                                    </div>
