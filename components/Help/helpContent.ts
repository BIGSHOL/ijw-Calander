...
const tabHelpData: Record<AppTab, Omit<HelpEntry, 'tab' | 'icon' | 'group'>> = {
  ...
  'tuition-calculator': {
    title: '수강료 계산',
    overview: '수강료 청구서를 생성하고 관리합니다. 과목·교재·할인 선택 후 A4 인쇄를 지원합니다.',
    sections: [
      {
        title: '계산기 모드',
        items: [
          '학생 정보 입력 (이름, 학교, 학년, 수강 기간)',
          '과목 선택 — 54개 과목 검색/추가, 시수·금액 자동 계산',
          '교재/기타 항목 — 교재 관리 카탈로그 연동, 셔틀·시스템사용료 등',
          '할인 적용 — 형제 할인, 사전 납부 할인 등',
          'A4 청구서 미리보기 및 인쇄',
        ],
      },
      {
        title: '설정 모드',
        requiredPermissions: ['tuition.manage'],
        items: [
          '수강료 설정 — 과목별 단가 조회',
          '교재/기타 설정 — 교재·기타 항목 조회',
          '할인 설정 — 할인 항목 조회',
          '공휴일 설정 — 공휴일 추가/삭제, 대한민국 공휴일 자동 등록',
          '세션 설정 — 월별 수업 기간 드래그 설정 (카테고리별)',
        ],
      },
      {
        title: '청구서 관리',
        items: [
          '청구서 저장/수정 (Firebase 연동)',
          '저장된 청구서 목록 조회 및 검색',
          '청구서 불러오기/삭제',
        ],
      },
