...
| # | 스킬 | 설명 |
|---|------|------|
| 1 | `verify-timetable` | 수학 시간표 도메인 패턴 검증 (React.memo, stale closure 방지, writeBatch, createPortal) |
| 2 | `verify-lazy-loading` | 탭/모달의 React.lazy + Suspense + ErrorBoundary 패턴 검증 |
