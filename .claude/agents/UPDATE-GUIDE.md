...
## 📦 v1.5 신규 에이전트 (2026-01-11)

### 1. 🧪 tdd-expert (TDD 전문가)

| 항목 | 내용 |
|------|------|
| **역할** | TDD 사이클 관리 (RED → GREEN → REFACTOR) |
| **중요도** | ⭐⭐⭐⭐☆ (권장) |
| **트리거 키워드** | "TDD", "테스트 먼저", "테스트 주도", "RED GREEN" |
| **파일 위치** | `agents/tdd-expert.md` |
...
### 2. 🎨 design-system-guardian (디자인 시스템 수호자)

| 항목 | 내용 |
|------|------|
| **역할** | UI/UX 일관성 점검, 디자인 시스템 관리 |
| **중요도** | ⭐⭐⭐⭐☆ (권장) |
| **트리거 키워드** | "디자인 점검", "UI 일관성", "타이포그래피", "색상 점검" |
| **파일 위치** | `agents/design-system-guardian.md` |
...
### 3. ⚡ performance-optimizer (성능 최적화 전문가)

| 항목 | 내용 |
|------|------|
| **역할** | 성능 분석 및 최적화 (번들, 렌더링, 메모리) |
| **중요도** | ⭐⭐⭐⭐☆ (권장) |
| **트리거 키워드** | "성능 분석", "성능 최적화", "느림", "번들 크기", "Lighthouse" |
| **파일 위치** | `agents/performance-optimizer.md` |
...
### 4. 🔄 migration-helper (마이그레이션 도우미)

| 항목 | 내용 |
|------|------|
| **역할** | 데이터/스키마 마이그레이션, 하위 호환성 관리 |
| **중요도** | ⭐⭐⭐⭐⭐ (필수) |
| **트리거 키워드** | "마이그레이션", "데이터 이전", "스키마 변경", "구조 통일" |
| **파일 위치** | `agents/migration-helper.md` |
...
```
"수학/영어 데이터 구조 통일해줘"
"Firestore 스키마 마이그레이션해줘"
"데이터 이전 계획 세워줘"
```

---

## 📦 v1.4 에이전트 (2026-01-09)

### 5. 🔒 security-auditor (보안 검사 전문가)
...
| notification-designer | 알림 설계 | v1.4 |
...
| analytics-expert | 데이터 분석 | v1.4 |
| report-summarizer | 리포트 요약 | v1.4 |
...
| **tdd-expert** | **TDD 사이클 관리** | **🆕 v1.5** |

### 디자인/성능 (2개)

| 에이전트 | 역할 | 상태 |
|---------|------|------|
| **design-system-guardian** | **UI/UX 일관성** | **🆕 v1.5** |
| **performance-optimizer** | **성능 최적화** | **🆕 v1.5** |

### 마이그레이션 (1개)

| 에이전트 | 역할 | 상태 |
|---------|------|------|
| **migration-helper** | **데이터 마이그레이션** | **🆕 v1.5** |
...
- ✅ design-system-guardian (UI/UX 일관성)
- ✅ performance-optimizer (성능 최적화)
- ✅ migration-helper (데이터 마이그레이션)

**업데이트됨**:
- ✅ README.md - 18개 에이전트, 11개 워크플로우 반영
- ✅ ROLE-CLARIFICATION.md - 18개 에이전트 역할 정의
- ✅ UPDATE-GUIDE.md - v1.5 반영
