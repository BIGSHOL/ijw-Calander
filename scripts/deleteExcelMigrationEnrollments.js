 ...
 * 
 * 사용법:
 *   DRY RUN: node scripts/deleteExcelMigrationEnrollments.js
 *   실제 삭제: node scripts/deleteExcelMigrationEnrollments.js --delete
 */
...
async function deleteExcelMigrationEnrollments(dryRun = true) {
    ...
    if (dryRun) {
        ...
        console.log('    node scripts/deleteExcelMigrationEnrollments.js --delete');
    } else {
        console.log('\n✅ 삭제 완료!');
    }
}
