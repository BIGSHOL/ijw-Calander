...
| `verify-class-tabs` | 수업 그룹(시간표/출석부/출결/수업/강의실/강의실배정) 탭의 핵심 기능을 검증합니다 |
| `verify-student-tabs` | 학생 그룹(학생관리/등록상담/학생상담/성적관리/퇴원관리) 탭의 핵심 기능을 검증합니다 |
| `verify-admin-tabs` | 관리 그룹(전자결재/직원관리/수납관리/자료실/역할관리) 탭의 핵심 기능을 검증합니다 |
